...
; ---------------------------------------------------------------
	...
	DAC_Entry	$08, KickProto, dpcm			; $81	- Kick
	DAC_Entry	$08, SnareProto, dpcm		; $82	- Snare
	DAC_Entry	$1B, TimpaniProto, dpcm		; $83	- Timpani
	dc.l	0,0					; $84	- <Free>
	dc.l	0,0					; $85	- <Free>
	dc.l	0,0					; $86	- <Free>
	dc.l	0,0					; $87	- <Free>
	DAC_Entry	$12, TimpaniProto, dpcm		; $88	- Hi-Timpani
	DAC_Entry	$15, TimpaniProto, dpcm		; $89	- Mid-Timpani
	DAC_Entry	$1B, TimpaniProto, dpcm		; $8A	- Mid-Low-Timpani
	DAC_Entry	$1D, TimpaniProto, dpcm		; $8B	- Low-Timpani
...
; ---------------------------------------------------------------
	...
	IncludeDAC	KickProto, bin
	IncludeDAC	SnareProto, bin
	IncludeDAC	TimpaniProto, bin
	even
